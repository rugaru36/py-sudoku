...
from game.game_data.generation.random_bool_matrix_generator import Random_Bool_Matrix_Generator
from game.game_data.generation.random_num_matrix_generator import Random_Num_Matrix_Generator
from game.game_data.io.matrixOutputManager import MatrixOutputManager
...
class GameProcessManager:
    ...
    def __init__(self, diff_lvl):
        ...
        self._game_hidden_matrix = self._random_bool_matrix_generator.get_rand(9, nums_to_input)
        self._game_state = Game_State_Manager(tries, nums_to_input)

        self._matrix_output = MatrixOutputManager(self._game_num_matrix, self._game_hidden_matrix)
